...
class Dashboard extends CI_Controller {
    ...
    public function index() {
       ...
       // $view['title']="titulo";
       // $this->parser->parse("core/templates/body",$view) ; //Para usar template
    ...
    public function movie_list(){
        ...
        //cargo vista
        $view['body']=$this->load->view("core/movies/list",$data,TRUE); //true hace que traiga el html
    ...
    public function movie_save($movie_id = null) {
       ...
       $vdata["movie_id"]= $vdata["type_movie_id"] = $vdata["name"] = $vdata["year"] = $vdata["description"] = $vdata["image"] = "";
        ...
        if ($this->input->server("REQUEST_METHOD") == "POST") {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $save["image"] = array("image" => $this->do_upload())["image"];
                ...
                $this->session->set_flashdata('msj', "Pelicula guardada"); //lives until next petition
      ...
      public function movie_delete_image($movie_id=null){
        ...
        $this->session->set_flashdata('msj', "Imagen eliminada"); //lives until next petition
        $this->session->set_flashdata('type', "success"); 
    ...
    public function type_movie_save($type_movie_id = null) {
        ...
        if ($this->input->server("REQUEST_METHOD") == "POST") {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $this->session->set_flashdata('msj', "Tipo guardado"); //lives until next petition
                $this->session->set_flashdata('type', "success"); 
    ...
    //No necesitamos mirar si es null o no ya que el usuario eta autenticado
    ...
    private function do_upload($uri='movies') {
        ...
        $config['max_height'] = 2160;           //guardar con nombre custom
